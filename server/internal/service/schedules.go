...
// once. Scan and backup ship disabled until an administrator opts in;
// prune ships enabled because the event log and stamp tables otherwise
// grow without bound.
var scheduleKinds = []string{"scan", "backup", "prune"}
