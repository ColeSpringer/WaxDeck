...
///
/// Drained rather than paged: the sheet is a picker over a list a
/// library has tens of, not thousands, and a merge target has to be
/// findable in one look. The page can come back short or empty with
/// more to come - the listing enumerates and hydrates separately, and
/// drops what the caller cannot see on top of that - so the loop
/// follows `nextCursor` rather than a non-empty page, and stops at a
/// bound so a pathological library cannot spin here.
