/// Web build of the reachability probe: nothing is ever fetchable.
///
...
/// a false from here would read as unreachable when it means
/// unaskable. Answering false keeps the code's own verdict standing.
