...
class RadioApi {
  ...
  /// Searches a public radio station directory (radio-browser.info) by name so stations can be added without pasting stream URLs. Requires internet; when the directory cannot be reached the endpoint answers &#x60;directory-unavailable&#x60; and manual entry still works. 
  ///
  /// Parameters:
