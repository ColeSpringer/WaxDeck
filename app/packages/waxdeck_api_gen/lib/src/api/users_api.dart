...
class UsersApi {
  ...
  /// Approves a pending account so it can log in, assigning its role, library access, and permissions in the same step (absent fields keep the registration defaults: the &#x60;user&#x60; role, access to every library, and default permissions). Administrators only. A user that is not pending answers &#x60;conflict&#x60;. 
  ///
  /// Parameters:
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [UserAccount] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserAccount>> approveSignupRequest({ 
    ...
    final _path = r'/users/requests/{userId}/approve'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(SignupApproval);
      _bodyData = signupApproval == null ? null : _serializers.serialize(signupApproval, specifiedType: _type);
    ...
    UserAccount? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UserAccount),
      ) as UserAccount;
  ...
  /// Create an invite
  /// Creates an invite link token that pre-approves signup with the given role, library access, and permissions (absent fields use the registration defaults). The response is the only place the token ever appears; the server stores a hash. Administrators only. 
  ///
  /// Parameters:
  /// * [inviteCreate] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [InviteCreated] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InviteCreated>> createInvite({ 
    ...
    try {
      const _type = FullType(InviteCreate);
      _bodyData = inviteCreate == null ? null : _serializers.serialize(inviteCreate, specifiedType: _type);
    ...
    InviteCreated? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(InviteCreated),
      ) as InviteCreated;
  ...
  /// Returns a [Future] containing a [Response] with a [UserAccount] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserAccount>> createUser({ 
  ...
  /// Delete an account
  /// Deletes the account and revokes all its sessions. Administrators only, and never the calling account or the last enabled administrator (&#x60;conflict&#x60;). The user&#39;s listening history in the catalog is orphaned, not destroyed. 
  ///
  /// Parameters:
  /// * [userId] - User PID (e.g. `us-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// The calling user&#39;s preferences. Unset fields are absent; clients apply their own defaults. 
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Prefs>> getPrefs({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Get one account
  /// Full account detail. Administrators can read any account; everyone else only their own. 
  ///
  /// Parameters:
  /// * [userId] - User PID (e.g. `us-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Returns a [Future] containing a [Response] with a [UserAccount] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserAccount>> getUser({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// List invites
  /// Every invite, newest first, revoked and exhausted ones included (the list is the record of who was let in with what). Invite tokens are never returned here; a token is shown exactly once, by the create response. Administrators only. 
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [InviteList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InviteList>> listInvites({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    InviteList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(InviteList),
      ) as InviteList;
  ...
  /// Keyset-paginated pending accounts (self-serve registrations awaiting a decision), oldest first so the queue drains in arrival order. Administrators only. Pending accounts also carry &#x60;pending: true&#x60; when they appear anywhere else. 
  ///
  /// Parameters:
  /// * [cursor] - Opaque keyset cursor from a previous page's `nextCursor`. Omit for the first page. 
  /// * [limit] - Maximum requests per page.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserPage>> listSignupRequests({ 
    String? cursor,
    int? limit = 100,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Prefs] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Prefs>> putPrefs({ 
    ...
    try {
      const _type = FullType(Prefs);
      _bodyData = _serializers.serialize(prefs, specifiedType: _type);
  ...
  /// Rejects and deletes a pending account. The username becomes available again. Administrators only. A user that is not pending answers &#x60;conflict&#x60; (reject never deletes an active account). 
  ///
  /// Parameters:
  /// * [userId] - User PID (e.g. `us-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> rejectSignupRequest({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/requests/{userId}/reject'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Revoke an invite
  /// Revokes the invite so its token stops working. Accounts it already admitted are unaffected. The invite stays listed as revoked. Administrators only. 
  ///
  /// Parameters:
  /// * [inviteId] - Invite PID (e.g. `iv-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> revokeInvite({ 
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> revokeUserSessions({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Update an account
  /// Partial update: absent fields are unchanged. Administrators can update any field on any account; everyone else can change only their own &#x60;displayName&#x60;, and a non-administrator supplying any other field is rejected with &#x60;forbidden&#x60;, never silently ignored. Changes that would leave the server without an enabled administrator (demoting or disabling the last one) answer &#x60;conflict&#x60;. Setting &#x60;displayName&#x60; to the empty string clears it. 
  ///
  /// Parameters:
  /// * [userId] - User PID (e.g. `us-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [userUpdate] 
  ...
  /// Returns a [Future] containing a [Response] with a [UserAccount] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserAccount>> updateUser({ 
    required String userId,
