...
class LibraryApi {
  ...
  ///
  /// Parameters:
  /// * [pid] - Type-prefixed item PID (e.g. `tr-01JZX5N8QW3F4V9T2B7KDEXAMPLE`).
  ...
  /// Keyset-paginated list of library items, optionally filtered by media type. Ordering is stable (title, then pid) so cursors never skip or duplicate. Development stub: serves a small built-in catalog. The WaxBin-backed catalog replaces it once the library integration lands. 
  ///
  /// Parameters:
