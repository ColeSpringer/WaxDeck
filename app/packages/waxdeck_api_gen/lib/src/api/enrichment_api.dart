...
class EnrichmentApi {
  ...
  Future<Response<EnrichmentStatus>> getEnrichmentStatus({ 
    ...
    final _path = r'/library/enrichment';
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EnrichmentRunResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EnrichmentRunResult>> runEnrichment({ 
    EnrichmentRunRequest? enrichmentRunRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/library/enrichment/run';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(EnrichmentRunRequest);
      _bodyData = enrichmentRunRequest == null ? null : _serializers.serialize(enrichmentRunRequest, specifiedType: _type);
    ...
    EnrichmentRunResult? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EnrichmentRunResult),
      ) as EnrichmentRunResult;
    ...
    return Response<EnrichmentRunResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
