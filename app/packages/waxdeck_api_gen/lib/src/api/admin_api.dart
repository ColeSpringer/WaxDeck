...
class AdminApi {
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> cancelStagedRestore({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/admin/backups/restore';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ToolTask] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ToolTask>> createMigration({ 
    required MigrationCreate migrationCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/admin/migrations';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(MigrationCreate);
      _bodyData = _serializers.serialize(migrationCreate, specifiedType: _type);
  ...
  /// Deletes the archive file and its record. The backup a staged restore points at cannot be deleted (&#x60;conflict&#x60;). Administrators only. 
  ///
  /// Parameters:
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Uint8List>> downloadBackup({ 
    required String backupId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/admin/backups/{backupId}/archive'.replaceAll('{' r'backupId' '}', encodeQueryParameter(_serializers, backupId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TrashEmptyResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TrashEmptyResult>> emptyTrash({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/admin/trash/empty';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    TrashEmptyResult? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TrashEmptyResult),
      ) as TrashEmptyResult;
    ...
    return Response<TrashEmptyResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// The runtime-editable server settings. Administrators only. 
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminSettings] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminSettings>> getAdminSettings({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    AdminSettings? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminSettings),
      ) as AdminSettings;
  ...
  /// Inspect a backup
  /// One backup archive&#39;s record. Administrators only.
  ///
  /// Parameters:
  /// * [backupId] - Backup PID (e.g. `bu-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// What the catalog&#39;s cache of enrichment answers holds, by request kind, and the share a prune leaves alone. Read-only. Administrators only. 
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EnrichmentCacheReport] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EnrichmentCacheReport>> getEnrichmentCache({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/admin/enrichment-cache';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    EnrichmentCacheReport? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EnrichmentCacheReport),
      ) as EnrichmentCacheReport;
    ...
    return Response<EnrichmentCacheReport>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Get one job&#39;s state
  /// State and progress of a server-run catalog job.
  ///
  /// Parameters:
  ...
  Future<Response<Job>> getJob({ 
    ...
    final _path = r'/jobs/{pid}'.replaceAll('{' r'pid' '}', encodeQueryParameter(_serializers, pid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ScrobblingAdminConfig] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ScrobblingAdminConfig>> getScrobblingConfig({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/admin/scrobbling';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ScrobblingAdminConfig? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ScrobblingAdminConfig),
      ) as ScrobblingAdminConfig;
    ...
    return Response<ScrobblingAdminConfig>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// The currently staged restore plan, when one exists (&#x60;not-found&#x60; otherwise). Administrators only. 
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RestorePlan] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RestorePlan>> getStagedRestore({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    RestorePlan? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RestorePlan),
      ) as RestorePlan;
  ...
  /// The server&#39;s transcode session limits and default bitrate ceiling. Administrators only. 
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TranscodingLimits] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TranscodingLimits>> getTranscodingLimits({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/admin/transcoding';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    TranscodingLimits? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TranscodingLimits),
      ) as TranscodingLimits;
    ...
    return Response<TranscodingLimits>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [Backup] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Backup>> importBackup({ 
    ...
    final _path = r'/admin/backups/import';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Keyset-paginated audit log of administrative and destructive actions (account changes, permission changes, deletions, merges, backup and restore operations, trash operations, settings changes), newest first, with the acting user, the target, and action detail. Names are denormalized at write time so entries outlive their actors and targets. The scheduled prune keeps a bounded history (the newest tens of thousands of entries). Administrators only. 
  ///
  /// Parameters:
  /// * [cursor] - Opaque keyset cursor from a previous page's `nextCursor`. Omit for the first page. 
  /// * [limit] - Maximum events per page.
  /// * [action] - Only events whose action equals this value, or starts with it when it ends in a dot (`playlist.` matches every playlist action). 
  /// * [actorId] - Only events performed by this user.
  /// * [targetPid] - Only events targeting this PID.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AuditEventPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuditEventPage>> listAuditEvents({ 
    String? cursor,
    int? limit = 100,
    String? action,
    String? actorId,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (targetPid != null) r'targetPid': encodeQueryParameter(_serializers, targetPid, const FullType(String)),
    };
    ...
    AuditEventPage? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AuditEventPage),
      ) as AuditEventPage;
    ...
    return Response<AuditEventPage>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Every backup archive the server holds, newest first, including the one currently being written (state &#x60;running&#x60;) and imported archives. Administrators only. 
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BackupList>> listBackups({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [JobList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JobList>> listJobs({ 
    int? limit = 50,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    JobList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(JobList),
      ) as JobList;
  ...
  Future<Response<Libraries>> listLibraries({ 
    ...
    Libraries? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(Libraries),
      ) as Libraries;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ScheduleList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ScheduleList>> listSchedules({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    ScheduleList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ScheduleList),
      ) as ScheduleList;
  ...
  /// List the trash
  /// The catalog&#39;s deletion undo journal, newest first: every file deleted to the trash and not yet purged, with what it was and where it lived. Bounded by &#x60;limit&#x60; rather than cursor-paged: the journal is small by nature and the source surface is limit-only. Administrators only. 
  ///
  /// Parameters:
  /// * [includeRestored] - Also list entries that were already restored.
  ...
  Future<Response<TrashList>> listTrash({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (includeRestored != null) r'includeRestored': encodeQueryParameter(_serializers, includeRestored, const FullType(bool)),
      if (limit != null) r'limit': encodeQueryParameter(_serializers, limit, const FullType(int)),
    };
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TrashList),
      ) as TrashList;
  ...
  /// Drops cached answers to fit the policy. A pruned answer costs one request on its next re-ask, never a catalog value; the archive&#39;s group records are kept. At least one bound. Administrators only. 
  ///
  /// Parameters:
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EnrichmentCachePruneResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EnrichmentCachePruneResult>> pruneEnrichmentCache({ 
    required EnrichmentCachePruneRequest enrichmentCachePruneRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/admin/enrichment-cache/prune';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(EnrichmentCachePruneRequest);
      _bodyData = _serializers.serialize(enrichmentCachePruneRequest, specifiedType: _type);
    ...
    EnrichmentCachePruneResult? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EnrichmentCachePruneResult),
      ) as EnrichmentCachePruneResult;
    ...
    return Response<EnrichmentCachePruneResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TrashPurgeResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TrashPurgeResult>> purgeTrashEntry({ 
    ...
    final _path = r'/admin/trash/{trashId}'.replaceAll('{' r'trashId' '}', encodeQueryParameter(_serializers, trashId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
    ...
    TrashPurgeResult? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TrashPurgeResult),
      ) as TrashPurgeResult;
    ...
    return Response<TrashPurgeResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Replaces the runtime settings with the given object and returns the stored result. Settings apply immediately, no restart. Administrators only. 
  ///
  /// Parameters:
  /// * [adminSettings] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Returns a [Future] containing a [Response] with a [AdminSettings] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminSettings>> putAdminSettings({ 
    required AdminSettings adminSettings,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(AdminSettings);
      _bodyData = _serializers.serialize(adminSettings, specifiedType: _type);
  ...
  /// Sets one schedule. &#x60;cron&#x60; is a five-field cron expression (minute, hour, day of month, month, day of week; &#x60;*&#x60;, lists, ranges, and &#x60;*_/n&#x60; steps), evaluated in the server&#39;s local time. A malformed expression answers &#x60;invalid-request&#x60; and names the field. Administrators only. 
  ///
  /// Parameters:
  /// * [kind] - Which scheduled job.
  /// * [schedulePut] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Schedule>> putSchedule({ 
    required ScheduleKind kind,
    required SchedulePut schedulePut,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/admin/schedules/{kind}'.replaceAll('{' r'kind' '}', encodeQueryParameter(_serializers, kind, const FullType(ScheduleKind)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SchedulePut);
      _bodyData = _serializers.serialize(schedulePut, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [ScrobblingAdminConfig] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ScrobblingAdminConfig>> putScrobblingConfig({ 
    required ScrobblingAdminConfigPut scrobblingAdminConfigPut,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(ScrobblingAdminConfigPut);
      _bodyData = _serializers.serialize(scrobblingAdminConfigPut, specifiedType: _type);
  ...
  /// Replaces the transcode limits and returns the stored result. Limits are enforced at the media proxy when a stream needs the streaming engine: direct-played originals never count. An over-limit stream request answers &#x60;transcode-limited&#x60;. A per-account bitrate ceiling on the account&#39;s permissions overrides &#x60;defaultMaxBitrateKbps&#x60;. Administrators only (administrators&#39; own streams are exempt from the per-user cap but count toward and respect the global one). 
  ///
  /// Parameters:
  /// * [transcodingLimits] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Returns a [Future] containing a [Response] with a [TranscodingLimits] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TranscodingLimits>> putTranscodingLimits({ 
    required TranscodingLimits transcodingLimits,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(TranscodingLimits);
      _bodyData = _serializers.serialize(transcodingLimits, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> restoreTrashEntry({ 
    required String trashId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/admin/trash/{trashId}/restore'.replaceAll('{' r'trashId' '}', encodeQueryParameter(_serializers, trashId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [LibraryReadOnly] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LibraryReadOnly>> setLibraryReadOnly({ 
    required String pid,
    required LibraryReadOnly libraryReadOnly,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(LibraryReadOnly);
      _bodyData = _serializers.serialize(libraryReadOnly, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [RestorePlan] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RestorePlan>> stageRestore({ 
    required String backupId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/admin/backups/{backupId}/restore'.replaceAll('{' r'backupId' '}', encodeQueryParameter(_serializers, backupId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
