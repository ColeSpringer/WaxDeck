...
class BooksApi {
  ...
  Future<Response<Bookmark>> createBookmark({ 
    required String pid,
    required BookmarkCreate bookmarkCreate,
    ...
    final _path = r'/books/{pid}/bookmarks'.replaceAll('{' r'pid' '}', encodeQueryParameter(_serializers, pid, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(BookmarkCreate);
      _bodyData = _serializers.serialize(bookmarkCreate, specifiedType: _type);
    ...
    Bookmark? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(Bookmark),
      ) as Bookmark;
  ...
  Future<Response<void>> deleteBookmark({ 
    ...
    final _path = r'/books/{pid}/bookmarks/{bookmarkId}'.replaceAll('{' r'pid' '}', encodeQueryParameter(_serializers, pid, const FullType(String)).toString()).replaceAll('{' r'bookmarkId' '}', encodeQueryParameter(_serializers, bookmarkId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Full audiobook detail: contributors, series membership, chapters on the book timeline, backing parts in reading order, and the calling user&#39;s per-book playback settings. Positions everywhere on this surface are book-timeline milliseconds spanning all parts. 
  ///
  /// Parameters:
  /// * [pid] - Type-prefixed PID (e.g. `tr-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BookDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BookDetail>> getBook({ 
    required String pid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/books/{pid}'.replaceAll('{' r'pid' '}', encodeQueryParameter(_serializers, pid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BookDetail? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BookDetail),
      ) as BookDetail;
  ...
  /// The calling user&#39;s resume point on the book timeline, with the chapter that position falls in (when the book has chapters). This is the cross-device resume answer: the position reflects the newest checkpoint from any device after the server&#39;s per-medium reconciliation. 
  ///
  /// Parameters:
  /// * [pid] - Type-prefixed PID (e.g. `tr-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BookResume] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BookResume>> getBookResume({ 
    required String pid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/books/{pid}/resume'.replaceAll('{' r'pid' '}', encodeQueryParameter(_serializers, pid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BookResume? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BookResume),
      ) as BookResume;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BookSeriesPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BookSeriesPage>> listBookSeries({ 
    String? cursor,
    int? limit = 100,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    BookSeriesPage? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BookSeriesPage),
      ) as BookSeriesPage;
    ...
    return Response<BookSeriesPage>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// The calling user&#39;s bookmarks for one book, ordered by position on the book timeline. Bookmarks are places a listener marked on purpose, which is a different thing from the resume point: a book has one resume position and any number of bookmarks, and nothing here moves as playback does. The whole set comes back in one answer - a book holds a handful of these, not a catalog - so there is no cursor. 
  ///
  /// Parameters:
  /// * [pid] - Type-prefixed PID (e.g. `tr-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BookmarkList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BookmarkList>> listBookmarks({ 
    required String pid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Full replace of the calling user&#39;s per-book playback settings (speed memory, voice boost, silence trimming). Absent fields reset to their defaults, so clients send the complete object. 
  ///
  /// Parameters:
  /// * [pid] - Type-prefixed PID (e.g. `tr-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [bookSettings] 
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BookSettings] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BookSettings>> putBookSettings({ 
    required String pid,
    required BookSettings bookSettings,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/books/{pid}/settings'.replaceAll('{' r'pid' '}', encodeQueryParameter(_serializers, pid, const FullType(String)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(BookSettings);
      _bodyData = _serializers.serialize(bookSettings, specifiedType: _type);
