...
class PlaylistsApi {
  ...
  /// Appends items in the given order. Owner only; static playlists only. Duplicates are allowed (a playlist may repeat a track); clients wanting dedupe check membership first. 
  ///
  /// Parameters:
  ...
  Future<Response<void>> addPlaylistItems({ 
    required String pid,
    required PlaylistItemsUpdate playlistItemsUpdate,
    ...
    final _path = r'/playlists/{pid}/items'.replaceAll('{' r'pid' '}', encodeQueryParameter(_serializers, pid, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(PlaylistItemsUpdate);
      _bodyData = _serializers.serialize(playlistItemsUpdate, specifiedType: _type);
  ...
  Future<Response<Playlist>> createPlaylist({ 
    required PlaylistCreate playlistCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PlaylistCreate);
      _bodyData = _serializers.serialize(playlistCreate, specifiedType: _type);
  ...
  Future<Response<void>> deletePlaylist({ 
    ...
    final _path = r'/playlists/{pid}'.replaceAll('{' r'pid' '}', encodeQueryParameter(_serializers, pid, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> exportPlaylistM3u({ 
    required String pid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/playlists/{pid}/m3u'.replaceAll('{' r'pid' '}', encodeQueryParameter(_serializers, pid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltMap<String, JsonObject>>> exportPlaylistNsp({ 
    ...
    final _path = r'/playlists/{pid}/nsp'.replaceAll('{' r'pid' '}', encodeQueryParameter(_serializers, pid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// The external source a manual playlist is bound to, with its sync settings and health: mode, interval, the last completed run&#39;s counts, and the failure state that decides whether scheduled syncs still run. Owner only; &#x60;not-found&#x60; when the playlist has no binding. 
  ///
  /// Parameters:
  /// * [pid] - Type-prefixed PID (e.g. `tr-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PlaylistSource] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PlaylistSource>> getPlaylistSource({ 
    required String pid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/playlists/{pid}/source'.replaceAll('{' r'pid' '}', encodeQueryParameter(_serializers, pid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PlaylistSource? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PlaylistSource),
      ) as PlaylistSource;
    ...
    return Response<PlaylistSource>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RuleFields] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RuleFields>> getRuleFields({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/playlists/rule-fields';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RuleFields? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RuleFields),
      ) as RuleFields;
  ...
  /// Creates a static playlist from an M3U8 document, matching each entry to a cataloged item by exact path or unique relative-path suffix. Unmatched paths are skipped and reported, never invented; an empty document yields an empty playlist. 
  ///
  /// Parameters:
  /// * [m3uImport] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [M3uImportResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<M3uImportResult>> importPlaylistM3u({ 
    required M3uImport m3uImport,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(M3uImport);
      _bodyData = _serializers.serialize(m3uImport, specifiedType: _type);
    ...
    M3uImportResult? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(M3uImportResult),
      ) as M3uImportResult;
    ...
    return Response<M3uImportResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PlaylistItemsPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PlaylistItemsPage>> listPlaylistItems({ 
    required String pid,
    String? cursor,
    int? limit = 100,
    CancelToken? cancelToken,
    ...
    PlaylistItemsPage? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PlaylistItemsPage),
    ...
    return Response<PlaylistItemsPage>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Keyset-paginated list of the caller&#39;s own playlists plus every shared playlist, ordered by name then pid. A static entry carries a live &#x60;itemCount&#x60;, exact for this caller. Smart entries omit it (evaluating every rule to draw a page of tiles is work a listing does not do); fetch the playlist detail for a computed count.  Every account is seeded with one smart playlist, \&quot;Most played\&quot; (music, play count above zero, most played first, capped at 50). It is ordinary in every other way: the account owns it and may rename it, re-rule it, share it, or delete it, and a deletion sticks. 
  ///
  /// Parameters:
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PlaylistPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PlaylistPage>> listPlaylists({ 
    String? cursor,
    int? limit = 100,
    String? containsItem,
    CancelToken? cancelToken,
    ...
    final _queryParameters = <String, dynamic>{
      if (cursor != null) r'cursor': encodeQueryParameter(_serializers, cursor, const FullType(String)),
      if (limit != null) r'limit': encodeQueryParameter(_serializers, limit, const FullType(int)),
      if (containsItem != null) r'containsItem': encodeQueryParameter(_serializers, containsItem, const FullType(String)),
    };
    ...
    PlaylistPage? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PlaylistPage),
      ) as PlaylistPage;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PlaylistSyncPreview] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PlaylistSyncPreview>> previewPlaylistSync({ 
    required String pid,
    PlaylistSourceUpdate? playlistSourceUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/playlists/{pid}/source/preview'.replaceAll('{' r'pid' '}', encodeQueryParameter(_serializers, pid, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(PlaylistSourceUpdate);
      _bodyData = playlistSourceUpdate == null ? null : _serializers.serialize(playlistSourceUpdate, specifiedType: _type);
    ...
    PlaylistSyncPreview? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PlaylistSyncPreview),
      ) as PlaylistSyncPreview;
    ...
    return Response<PlaylistSyncPreview>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Evaluates a rule without storing anything and returns the first matching items plus the total match count, computed against the caller&#39;s own user state and library visibility. Rule editors call this while the user builds the rule. 
  ///
  /// Parameters:
  /// * [smartRule] 
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PlaylistPreview] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PlaylistPreview>> previewSmartRule({ 
    required SmartRule smartRule,
    int? limit = 50,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/playlists/preview';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SmartRule);
      _bodyData = _serializers.serialize(smartRule, specifiedType: _type);
    ...
    PlaylistPreview? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PlaylistPreview),
      ) as PlaylistPreview;
    ...
    return Response<PlaylistPreview>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Removes the member at the given zero-based position in the stored order. Owner only; static playlists only. Positions are the unfiltered stored order (visibility filtering never shifts them); take them from the item listing&#39;s &#x60;position&#x60; field, not from a rendered row index. 
  ///
  /// Parameters:
  /// * [pid] - Type-prefixed PID (e.g. `tr-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [position] - Zero-based position in the stored member order.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> removePlaylistItemAt({ 
    required String pid,
    ...
    final _path = r'/playlists/{pid}/items/{position}'.replaceAll('{' r'pid' '}', encodeQueryParameter(_serializers, pid, const FullType(String)).toString()).replaceAll('{' r'position' '}', encodeQueryParameter(_serializers, position, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> replacePlaylistItems({ 
    required String pid,
    required PlaylistItemsUpdate playlistItemsUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Binds a manual playlist to an external source and stores its sync settings, replacing any previous binding whole - every field is written from this body, so always send the complete settings. A &#x60;url&#x60; names a live source (a YouTube playlist) that the server re-enumerates on the stored interval and on demand, downloading new entries through the normal review queue; &#x60;source&#x60; plus &#x60;payload&#x60; or &#x60;refs&#x60; records a matched source (a streaming export), which reconciles match-only and on demand, downloading nothing. Exactly one of the two forms must be set.  Modes: &#x60;append&#x60; adds new source entries and never touches manual edits; &#x60;mirror&#x60; makes membership and order follow the source, keeping a removed entry&#39;s file in the library; &#x60;mirror-trash&#x60; additionally moves a removed entry&#39;s file to the recoverable trash, and selecting it needs the delete right (administrators implicitly). Matched sources take &#x60;append&#x60; or &#x60;mirror&#x60; only, and no interval - a static export never changes by itself. Owner only; static playlists only (a smart playlist&#39;s membership is its rule). Live sources need a running acquisition bridge (&#x60;source-unavailable&#x60; without one). Binding does not sync by itself: the first scheduled run comes one interval after the bind, and the sync endpoint runs one now. 
  ///
  /// Parameters:
  /// * [pid] - Type-prefixed PID (e.g. `tr-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [playlistSourceUpdate] 
  ...
  /// Returns a [Future] containing a [Response] with a [PlaylistSource] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PlaylistSource>> setPlaylistSource({ 
    required String pid,
    required PlaylistSourceUpdate playlistSourceUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PlaylistSourceUpdate);
      _bodyData = _serializers.serialize(playlistSourceUpdate, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ToolTask>> syncPlaylistSource({ 
    required String pid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/playlists/{pid}/source/sync'.replaceAll('{' r'pid' '}', encodeQueryParameter(_serializers, pid, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Removes the binding and its per-playlist sync bookkeeping. The playlist and its members stay exactly as they are; nothing is downloaded, removed, or trashed again. Owner only; &#x60;not-found&#x60; when the playlist has no binding. 
  ///
  /// Parameters:
  /// * [pid] - Type-prefixed PID (e.g. `tr-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> unbindPlaylistSource({ 
    required String pid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<Playlist>> updatePlaylist({ 
    required String pid,
    required PlaylistUpdate playlistUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PlaylistUpdate);
      _bodyData = _serializers.serialize(playlistUpdate, specifiedType: _type);
