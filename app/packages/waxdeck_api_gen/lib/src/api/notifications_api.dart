...
class NotificationsApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [NotificationTarget] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationTarget>> createMyNotificationTarget({ 
    required NotificationTargetCreate notificationTargetCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/me/notification-targets';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(NotificationTargetCreate);
      _bodyData = _serializers.serialize(notificationTargetCreate, specifiedType: _type);
    ...
    NotificationTarget? _responseData;
    ...
    return Response<NotificationTarget>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [NotificationTarget] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationTarget>> createServerNotificationTarget({ 
    required NotificationTargetCreate notificationTargetCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/admin/notification-targets';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [targetId] - Notification target PID (e.g. `nt-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteMyNotificationTarget({ 
    ...
    final _path = r'/users/me/notification-targets/{targetId}'.replaceAll('{' r'targetId' '}', encodeQueryParameter(_serializers, targetId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [registrationId] - The registration's notification-target pid.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Removes the target; its queued deliveries are dropped. Administrators only. 
  ///
  /// Parameters:
  /// * [targetId] - Notification target PID (e.g. `nt-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteServerNotificationTarget({ 
    required String targetId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/admin/notification-targets/{targetId}'.replaceAll('{' r'targetId' '}', encodeQueryParameter(_serializers, targetId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [NotificationTargetList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationTargetList>> listMyNotificationTargets({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    NotificationTargetList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(NotificationTargetList),
      ) as NotificationTargetList;
    ...
    return Response<NotificationTargetList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationEventList>> listNotificationEvents({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/notifications/events';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// The calling user&#39;s UnifiedPush registrations: a compatibility view over the caller&#39;s &#x60;unifiedpush&#x60; notification targets. Unpaginated; the per-user cap is small. 
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// Returns a [Future] containing a [Response] with a [NotificationTargetList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationTargetList>> listServerNotificationTargets({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Queues one test delivery to this target, bypassing event selection. Answers as soon as the test is queued; the outcome lands on the target&#39;s health fields (&#x60;lastSuccessAt&#x60;, &#x60;lastError&#x60;, &#x60;lastErrorAt&#x60;), which the settings surface polls. 
  ///
  /// Parameters:
  /// * [targetId] - Notification target PID (e.g. `nt-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> testMyNotificationTarget({ 
    required String targetId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/me/notification-targets/{targetId}/test'.replaceAll('{' r'targetId' '}', encodeQueryParameter(_serializers, targetId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Queues one test delivery to this target, bypassing event selection. Administrators only. Answers as soon as the test is queued; the outcome lands on the target&#39;s health fields (&#x60;lastSuccessAt&#x60;, &#x60;lastError&#x60;), which the settings surface polls. 
  ///
  /// Parameters:
  /// * [targetId] - Notification target PID (e.g. `nt-01JZX5N8QW3F4V9T2B7KD3M9R6`).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> testServerNotificationTarget({ 
    required String targetId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/admin/notification-targets/{targetId}/test'.replaceAll('{' r'targetId' '}', encodeQueryParameter(_serializers, targetId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [NotificationTarget] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationTarget>> updateMyNotificationTarget({ 
    required String targetId,
    required NotificationTargetUpdate notificationTargetUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(NotificationTargetUpdate);
      _bodyData = _serializers.serialize(notificationTargetUpdate, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [NotificationTarget] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationTarget>> updateServerNotificationTarget({ 
    required String targetId,
    required NotificationTargetUpdate notificationTargetUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
