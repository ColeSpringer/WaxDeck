...
class SimilarityApi {
  ...
  const SimilarityApi(this._dio, this._serializers);

  /// Similarity analysis status
  /// Coverage of the sonic-similarity surface: whether a worker token is configured, which embedding model the stored vectors carry, how much of the library is embedded, and the analysis backlog. Clients use &#x60;coveragePct&#x60; to decide whether to show sonic affordances (the adventurousness knob, sonic paths). 
  ///
  /// Parameters:
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [SimilarityStatus] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SimilarityStatus>> getSimilarityStatus({ 
    ...
    final _path = r'/similarity/status';
    ...
    SimilarityStatus? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SimilarityStatus),
      ) as SimilarityStatus;
    ...
    return Response<SimilarityStatus>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SimilarityWorkPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SimilarityWorkPage>> pullSimilarityWork({ 
    int? limit = 10,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    SimilarityWorkPage? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SimilarityWorkPage),
      ) as SimilarityWorkPage;
    ...
    return Response<SimilarityWorkPage>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EmbeddingIngestResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmbeddingIngestResult>> reportEmbeddings({ 
    required EmbeddingReport embeddingReport,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/similarity/embeddings';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(EmbeddingReport);
      _bodyData = _serializers.serialize(embeddingReport, specifiedType: _type);
    ...
    EmbeddingIngestResult? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EmbeddingIngestResult),
      ) as EmbeddingIngestResult;
    ...
    return Response<EmbeddingIngestResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
