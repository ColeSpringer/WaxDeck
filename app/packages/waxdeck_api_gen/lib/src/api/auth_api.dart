...
class AuthApi {
  ...
  /// Returns whether the caller is authenticated and, if so, the session&#39;s user. Unauthenticated callers get &#x60;authenticated: false&#x60;, not a 401. Clients use this at startup to decide whether to show the login screen. 
  ///
  /// Parameters:
  ...
  /// Establishes a session and sets the &#x60;waxdeck_session&#x60; HttpOnly cookie. Native clients use the same endpoint and read the bearer token from the response body instead of the cookie. Development stub: any non-empty credentials are accepted and map to the built-in development user. Real account storage, roles, and OIDC come later. 
  ///
  /// Parameters:
  /// * [loginRequest] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
