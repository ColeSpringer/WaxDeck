...
class HealthApi {
  ...
  /// Keeps one item of an upgrade group and moves the named inferior encodings to the trash (recoverable within the retention window). Administrators only. 
  ///
  /// Parameters:
