...
class OrganizeApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [OrganizeReport] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OrganizeReport>> applyOrganize({ 
    required OrganizeRequest organizeRequest,
    ...
    try {
      const _type = FullType(OrganizeRequest);
      _bodyData = _serializers.serialize(organizeRequest, specifiedType: _type);
    ...
    OrganizeReport? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(OrganizeReport),
      ) as OrganizeReport;
    ...
    return Response<OrganizeReport>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OrganizeProfiles] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OrganizeProfiles>> listOrganizeProfiles({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/organize/profiles';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    OrganizeProfiles? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(OrganizeProfiles),
      ) as OrganizeProfiles;
    ...
    return Response<OrganizeProfiles>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OrganizePlan] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OrganizePlan>> previewOrganize({ 
    required OrganizeRequest organizeRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/organize/preview';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    OrganizePlan? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(OrganizePlan),
      ) as OrganizePlan;
