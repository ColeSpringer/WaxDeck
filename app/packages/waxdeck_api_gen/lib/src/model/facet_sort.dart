...
class FacetSort extends EnumClass {
  ...
  const FacetSort._(String name): super(name);

  static BuiltSet<FacetSort> get values => _$values;
  static FacetSort valueOf(String name) => _$valueOf(name);
}
...
abstract class FacetSortMixin = Object with _$FacetSortMixin;
