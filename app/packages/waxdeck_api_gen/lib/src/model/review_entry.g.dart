...
part of 'review_entry.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

abstract mixin class ReviewEntryBuilder {
  void replace(ReviewEntry other);
  void update(void Function(ReviewEntryBuilder) updates);
  String? get id;
  set id(String? id);
  ...
  set libraryPid(String? libraryPid);

  String? get uploadedBy;
  set uploadedBy(String? uploadedBy);

  bool? get identifying;
  set identifying(bool? identifying);

  CandidateSummaryBuilder get best;
  set best(CandidateSummaryBuilder? best);

  String? get appliedMbid;
  set appliedMbid(String? appliedMbid);

  DateTime? get createdAt;
  set createdAt(DateTime? createdAt);

  DateTime? get decidedAt;
  set decidedAt(DateTime? decidedAt);

  String? get decidedBy;
  set decidedBy(String? decidedBy);
}

class _$$ReviewEntry extends $ReviewEntry {
  @override
  final String id;
  @override
  final String kind;
  ...
  factory _$$ReviewEntry([void Function($ReviewEntryBuilder)? updates]) =>
      ($ReviewEntryBuilder()..update(updates))._build();
  ...
  @override
  $ReviewEntry rebuild(void Function($ReviewEntryBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  $ReviewEntryBuilder toBuilder() => $ReviewEntryBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is $ReviewEntry &&
        id == other.id &&
        kind == other.kind &&
        status == other.status &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'$ReviewEntry')
          ..add('id', id)
          ..add('kind', kind)
          ..add('status', status)
...
class $ReviewEntryBuilder
    implements Builder<$ReviewEntry, $ReviewEntryBuilder>, ReviewEntryBuilder {
  _$$ReviewEntry? _$v;
  ...
  $ReviewEntryBuilder() {
    $ReviewEntry._defaults(this);
  }

  $ReviewEntryBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
      _kind = $v.kind;
  ...
  @override
  void replace(covariant $ReviewEntry other) {
    _$v = other as _$$ReviewEntry;
  }
  ...
  @override
  $ReviewEntry build() => _build();

  _$$ReviewEntry _build() {
    _$$ReviewEntry _$result;
    try {
      _$result =
          _$v ??
          _$$ReviewEntry._(
