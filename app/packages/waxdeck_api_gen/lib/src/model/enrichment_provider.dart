...
abstract class EnrichmentProvider implements Built<EnrichmentProvider, EnrichmentProviderBuilder> {
  ...
  /// Whether the provider can run: a keyed one once its key is set, a built-in once the MusicBrainz contact is, since the catalog registers none of the key-free public services without one. 
