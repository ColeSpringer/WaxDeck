...
export const SemanticsIds = {
  ...
  migrateAccountOption: (id: string | number) => `migrate-account-${id}`,
  migrateExportPick: 'migrate-export-pick',
  migrateExportStatus: 'migrate-export-status',
  migrateLastfmMissingKey: 'migrate-lastfm-missing-key',
  ...
  bookSeriesCard: (pid: string | number) => `book-series-card-${pid}`,
  bookSeriesIndex: 'book-series-index',
  bookSeriesLink: 'book-series-link',
  bookSeriesRow: (index: string | number) => `book-series-row-${index}`,
  bookSeriesScreen: (pid: string | number) => `book-series-screen-${pid}`,
  bookSeriesSeeAll: 'book-series-see-all',
  ...
  notificationDelete: (id: string | number) => `notification-delete-${id}`,
  ...
  notificationsClearConfirm: 'notifications-clear-confirm',
  notificationsEmpty: 'notifications-empty',
  notificationsMarkAllRead: 'notifications-mark-all-read',
  notificationsPeekRead: 'notifications-peek-read',
  ...
  playlistSyncArm: 'playlist-sync-arm',
  playlistSyncArmOption: (arm: string | number) => `playlist-sync-arm-${arm}`,
  ...
  playlistSyncPayload: 'playlist-sync-payload',
  ...
  playlistSyncSource: 'playlist-sync-source',
  playlistSyncSourceOption: (source: string | number) => `playlist-sync-source-${source}`,
  ...
  radioScrobbleToggle: (pid: string | number) => `radio-scrobble-${pid}`,
...
export const SemanticsIdPrefixes = {
  ...
  migrateAccountOption: 'migrate-account-',
  ...
  bookSeriesCard: 'book-series-card-',
  bookSeriesRow: 'book-series-row-',
  bookSeriesScreen: 'book-series-screen-',
  bookSort: 'book-sort-',
  chapter: 'chapter-',
  ...
  playlistSyncSourceOption: 'playlist-sync-source-',
  ...
  radioScrobbleToggle: 'radio-scrobble-',
